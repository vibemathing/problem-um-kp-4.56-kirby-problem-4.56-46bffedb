...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.56-kirby-problem-4.56-46bffedb-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.56"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.56-kirby-problem-4.56-46bffedb-v1",
      "problem_contract_sha256": "804c4d8a340b8a29e8d57f4d16b70707163eae7765f06edac671b00da40866f2",
      "problem_id": "problem:um-kp-4.56-kirby-problem-4.56-46bffedb",
      "route_id": "route:um-kp-4.56-kirby-problem-4.56-46bffedb-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.56-kirby-problem-4.56-46bffedb-source-fidelity-01",
      "graph_id": "graph:um-kp-4.56-kirby-problem-4.56-46bffedb-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.56-kirby-problem-4.56-46bffedb-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.56-kirby-problem-4.56-46bffedb-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(4D s-cobordism conjecture). Let $(W^{4};M_{0}^{3}, M_{1}^{3})$ be a smooth 4-dimensionals-cobordism between closed 3-manifolds. Is W diffeomorphic to $M_{0} \\times$ [0,1]?"
          },
          "statement_sha256": "c94cf40edc987009e499420fde7e853acfa005aeb110017bb7eec0c577d280c5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.56-kirby-problem-4.56-46bffedb-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.56-kirby-problem-4.56-46bffedb-root",
      "route_id": "route:um-kp-4.56-kirby-problem-4.56-46bffedb-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.56-ac2c2d36d8dc",
        "url": "https://www.unsolvedmath.com/problems/KP-4.56"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
